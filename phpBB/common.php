...
$phpbb_template_provider = new phpbb_template_provider_extension($phpbb_extension_manager);
...
{
	$cron = new phpbb_cron_manager(new phpbb_cron_provider_extension($phpbb_extension_manager), $cache->get_driver());
}
