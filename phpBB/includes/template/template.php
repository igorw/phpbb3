...
class phpbb_template
{
	...
	* @param phpbb_template_provider $provider template path provider
	*/
	public function __construct($phpbb_root_path, $phpEx, $config, $user, phpbb_template_locator $locator, phpbb_template_provider_interface $provider)
	{
